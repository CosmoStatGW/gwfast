...
class GWSignal(object):
    ...
    def GWstrain(self, f, Mc, logdL, theta, phi, iota, psi, tcoal, eta, Phicoal, rot=0.):
    ...
    def FisherMatr(self, evParams, res=1000):
        ...
        if self.detector_shape=='L': 
            ...
            for i in range(3):
                # Change rot
                GWstrainRot = lambda f, Mc, logdL, theta, phi, iota, psi, tcoal, eta, Phicoal: self.GWstrain(f, Mc, logdL, theta, phi, iota, psi, tcoal, eta, Phicoal, rot=i*60.)
                # Build gradient
